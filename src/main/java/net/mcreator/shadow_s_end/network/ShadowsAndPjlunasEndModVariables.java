package net.mcreator.shadow_s_end.network;
...
@EventBusSubscriber
public class ShadowsAndPjlunasEndModVariables {
	public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, ShadowsAndPjlunasEndMod.MODID);

	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		ShadowsAndPjlunasEndMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	}
	...
	public static class WorldVariables extends SavedData {
		public static final SavedDataType<WorldVariables> TYPE = new SavedDataType<>("shadows_and_pjlunas_end_worldvars", ctx -> new WorldVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
		...
		public double time_freezen = 0;

		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			time_freezen = nbt.getDoubleOr("time_freezen", 0);
		}

		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			nbt.putDouble("time_freezen", time_freezen);
			return nbt;
		}
	...
	public static class MapVariables extends SavedData {
		public static final SavedDataType<MapVariables> TYPE = new SavedDataType<>("shadows_and_pjlunas_end_mapvars", ctx -> new MapVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(ShadowsAndPjlunasEndMod.MODID, "saved_data_sync"));
